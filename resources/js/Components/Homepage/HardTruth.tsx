      ...
      <>
        <div className="flex flex-col items-center px-4 bg-white text-black py-10">
          <div className="flex flex-col md:flex-row max-w-6xl w-full gap-8">
            {/* Left Column - Image */}
            <div className="w-30 h-full flex-grow">
              <img
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center pt-10 h-full">
          ...
          <div className="flex flex-col md:flex-row max-w-6xl w-full gap-8 pt-20">
            {/* Left Column - Content */}
            <div id="pricing" className="w-full md:w-1/2 flex flex-col justify-center pt-10 h-full">
            ...
            {/* Right Column - Image */}
            <div className="w-30 h-full flex-grow relative">
              <img
              ...
              />
               ...
               <img 
                    ...
                    className="rounded-xl h-25 absolute bottom-15 left-10 transform -translate-x-1/2"
                />
