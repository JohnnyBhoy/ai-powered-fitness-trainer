      ...
      <div className="bg-gray-900 text-white py-16 px-4 text-center">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto text-left">
          ...
          <div>
            ...
            <ul className="list-none list-inside text-md">
              <li>  <span className="text-[#23B5D3] font-bold mr-2">✓</span>Avocado, olive oil, eggs, and mdall amounts of cheese.</li>
        ...
        <a
          href="/register"
          className="mt-8 bg-[#23B5D3] hover:bg-[#23B5E3] text-white text-md font-bold py-3 px-6 rounded-full shadow-md inline-block text-center"
        >
