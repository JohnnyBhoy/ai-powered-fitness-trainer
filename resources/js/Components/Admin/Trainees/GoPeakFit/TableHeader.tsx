...
export default function TableHeader() {
    ...
    return (
        <div className="flex flex-col gap-2 px-4 py-4 border border-b-0 border-gray-100 dark:border-white/[0.03] rounded-t-xl sm:flex-row sm:items-center sm:justify-between">
